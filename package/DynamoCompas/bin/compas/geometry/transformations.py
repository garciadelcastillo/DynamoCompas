...
from compas.geometry.basic import scale_vector_2d
from compas.geometry.basic import normalize_vector
from compas.geometry.basic import normalize_vector_2d
...
__all__ = [
    'translate_points', 'translate_lines',
    'offset_line', 'offset_polygon',
    'rotate_points', 'rotate_points_degrees',
    'orient_points',
    'mirror_points_point', 'mirror_point_line', 'mirror_points_line', 'mirror_point_plane',
    'mirror_points_plane', 'mirror_vector_vector',
    'reflect_line_plane', 'reflect_line_triangle',
    'project_point_plane', 'project_points_plane', 'project_point_line', 'project_points_line',
]
...
def mirror_points_line_2d(point, line):
    pass
