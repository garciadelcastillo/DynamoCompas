...
def minlmsetcond(*functionargs):
    ...
    try:
        ...
        # call function
        _net_alglib.minlmsetcond(_net_state, _net_epsg, _net_epsf, _net_epsx, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def lsfitsetcond(*functionargs):
    # unpack inputs
    state, epsf, epsx, maxits = functionargs
    friendly_form = False
    ...
    try:
        ...
        # call function
        _net_alglib.lsfitsetcond(_net_state, _net_epsf, _net_epsx, _net_maxits)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
...
def rbfunpack(*functionargs):
    ...
    try:
        ...
        # call function
        _net_nx, _net_ny, _net_xwr, _net_nc, _net_v = _net_alglib.rbfunpack(_net_s)
    except _net_alglib.alglibexception as e:
        raise RuntimeError(e.msg)
