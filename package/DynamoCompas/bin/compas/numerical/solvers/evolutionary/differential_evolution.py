...
def de_solver(fn, bounds, population, iterations, limit=0, results=None, vectored=False, F=0.8, CR=0.9, name='f',
              polish=False, args=()):
...
if __name__ == "__main__":
    ...
    bounds = [(-10, 10), (-10, 10)]
    fopt, uopt = de_solver(fn, bounds, population=20, iterations=20, polish=True)
    print(fopt, uopt)
