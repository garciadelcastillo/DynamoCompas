...
from compas.geometry.planar import centroid_points_2d
from compas.geometry.planar import midpoint_line_2d
...
def create_axes_2d(figsize=(10, 7),
                   xlabel=None,
                   ylabel=None,
    ...
    """
    fig = plt.figure(facecolor=bgcolor, figsize=figsize)
...
def draw_xpoints_2d(points, axes):
    circles = []
    facecolors = []
    edgecolors = []
    linewidths = []
...
def draw_xarrows_2d(lines, axes):
    arrowprops = {
...
def draw_xlabels_2d(labels, axes):
    for label in labels:
        x, y      = label['pos']
        text      = label['text']
...
def draw_xpolygons_2d(polygons, axes):
    facecolors = []
    edgecolors = []
    linewidths = []
    patches = []
