...
def collapse_edge_mesh(mesh, u, v, t=0.5):
...
# - v on boundary
# - u and v on boundary
def collapse_edge_trimesh(mesh, u, v, t=0.5, allow_boundary=False, fixed=None):
    """Collapse an edge to its first or second vertex, or to an intermediate
    point.
    ...
    Example:
        ...
        .. plot::
            ...
            mesh.plot(vertexlabel={key: key for key in mesh.vertices()},
                      vertexsize=0.2,
                      facelabel={fkey: fkey for fkey in mesh.faces()})
