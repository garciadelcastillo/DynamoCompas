    ...
    for k in xrange(kmax):
        ...
        if count == 1:
            ...
            for u, v in mesh.wireframe():
                ...
                split_edge_trimesh(mesh, u, v, allow_boundary=allow_boundary_split)
        ...
        # collapse
            ...
            for u, v in mesh.wireframe():
                ...
                collapse_edge_trimesh(mesh, u, v, allow_boundary=allow_boundary_collapse, fixed=fixed)
        ...
        # swap
            ...
            for u, v in mesh.wireframe():
                ...
                swap_edge_trimesh(mesh, u, v, allow_boundary=allow_boundary_swap)
