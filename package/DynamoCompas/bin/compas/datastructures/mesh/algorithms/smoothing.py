...
def smooth_mesh_centroid(mesh, fixed=None, kmax=1, d=1.0, callback=None, callback_args=None):
    """"""
...
def smooth_mesh_centerofmass(mesh, fixed=None, kmax=1, d=1.0, callback=None, callback_args=None):
    """"""
...
def smooth_mesh_length(mesh, lmin, lmax, fixed=None, kmax=1, d=1.0, callback=None, callback_args=None):
    """"""
...
def smooth_mesh_area(mesh, fixed=None, kmax=1, d=1.0, callback=None, callback_args=None):
    """"""
...
def smooth_mesh_angle(mesh, fixed=None, kmax=1, callback=None, callback_args=None):
    """"""
...
if __name__ == '__main__':
    ...
    smooth_mesh_centroid(mesh, fixed=fixed, kmax=100, callback=callback, callback_args=(plotter, ))
