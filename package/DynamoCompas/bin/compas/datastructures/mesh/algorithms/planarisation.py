...
from compas.utilities._itertools import window
...
def planarize_mesh(mesh, fixed=None, kmax=100, d=1.0, callback=None, callback_args=None):
...
def planarize_mesh_shapeop(mesh, fixed=None, kmax=100, d=0.1, callback=None, callback_args=None):
...
def circularize_mesh(mesh, fixed=None, kmax=100, d=1.0, callback=None, callback_args=None):
    """"""
...
if __name__ == "__main__":
    ...
    planarize_mesh_shapeop(mesh, fixed=mesh.vertices_where({'is_fixed': True}), kmax=100)
