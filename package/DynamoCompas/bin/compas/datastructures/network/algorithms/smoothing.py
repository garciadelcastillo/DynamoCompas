...
def smooth_network_mixed(network,
                         smoothers,
                         lmin=None,
                         lmax=None,
                         fixed=None,
    ...
    Example:
        ...
        .. plot::
            ...
            from compas.datastructures.network.algorithms import smooth_network_mixed
            ...
            points = []
            for key, attr in smooth.vertices(True):
                points.append({
            ...
            lines = []
            for u, v, attr in smooth.edges(True):
                lines.append({
...
def smooth_network_area(network, fixed=None, kmax=1, d=0.5, callback=None, callback_args=None):
    ...
    Example:
        ...
        .. plot::
            ...
            from compas.datastructures.network import Network
            from compas.datastructures.network.algorithms import find_network_faces
            from compas.datastructures.network.algorithms import smooth_network_area
...
def smooth_network_mass(network, fixed=None, kmax=1, d=0.5, callback=None, callback_args=None):
    ...
    Example:
        ...
        .. plot::
            ...
            from compas.datastructures.network import Network
            from compas.datastructures.network.algorithms import find_network_faces
            from compas.datastructures.network.algorithms import smooth_network_mass
...
if __name__ == '__main__':
    ...
    smooth_network_centroid(smooth,
                            fixed=fixed,
                            kmax=10,
                            callback=callback,
